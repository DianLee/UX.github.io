...
function carousel01() {
  var i;
  var x = document.getElementsByClassName("activeSlides01");
  for (i = 0; i < x.length; i++) {
    x[i].style.display = "none";
  }
  activeslide01++;
  if (activeslide01 > x.length) {activeslide01 = 1}
  x[activeslide01-1].style.display = "block";
...
function plusDivs01(n) {
  showDivs01(slideIndex01 += n);
}

function currentDiv01(n) {
  showDivs01(slideIndex01 = n);
}

function showDivs01(n) {
  var i;
  var x = document.getElementsByClassName("mySlides01");
  var dots = document.getElementsByClassName("demo01");
  if (n > x.length) {slideIndex01 = 1}
  if (n < 1) {slideIndex01 = x.length}
  for (i = 0; i < x.length; i++) {
    x[i].style.display = "none";  
  }
  ...
  dots[slideIndex01-1].className += " w3-white";
}

// =====
var slideIndex02 = 1;
showDivs02(slideIndex02);

function plusDivs02(n) {
  showDivs02(slideIndex02 += n);
}

function currentDiv02(n) {
  showDivs02(slideIndex02 = n);
}

function showDivs02(n) {
  var i;
  var x = document.getElementsByClassName("mySlides02");
  var dots = document.getElementsByClassName("demo02");
  if (n > x.length) {slideIndex02 = 1}
  if (n < 1) {slideIndex02 = x.length}
  for (i = 0; i < x.length; i++) {
    x[i].style.display = "none";  
  }
  for (i = 0; i < dots.length; i++) {
  ...
  dots[slideIndex02-1].className += " w3-white";
}
